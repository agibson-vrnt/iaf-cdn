...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Drainable = __webpack_require__(182);

	var _Drainable2 = _interopRequireDefault(_Drainable);

	var _scriptjs = __webpack_require__(183);
	...
	(function loader(namespace, config) {
		...
		(0, _scriptjs2.default)(required(config.iaf.url, "iaf.url - the URL of the iaf client script"), function () {
			...
			(0, _scriptjs2.default)(required(config.partials.url, "partials.url - the URL to load partials from"), function () {
